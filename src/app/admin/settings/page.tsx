...
const imageSettings: ImageSetting[] = [
  ...
  { key: "homeHeroImage", title: "메인 배너", description: "메인 페이지 상단 배너 이미지입니다.", defaultImage: "/images/home-bg.png" },
  { key: "aboutHeroImage", title: "회사소개 배너", description: "회사소개 페이지 상단 배너 이미지입니다.", defaultImage: "/images/home-hero-bg.png" },
  { key: "businessHeroImage", title: "솔루션 배너", description: "솔루션 페이지 상단 배너 이미지입니다.", defaultImage: "/images/sulutions-bg-0.png" },
  { key: "promotionHeroImage", title: "홍보센터 배너", description: "홍보센터 목록과 상세 페이지에 함께 적용됩니다.", defaultImage: "/images/promotion-hero.png" },
  { key: "contactHeroImage", title: "Contact 배너", description: "Contact 페이지 상단 배너 이미지입니다.", defaultImage: "/images/contact-hero.png" },
  { key: "productHeroImage1", title: "제품 배너 1", description: "제품 페이지 첫 번째 슬라이드입니다.", defaultImage: "/images/product_bg.png" },
  { key: "productHeroImage2", title: "제품 배너 2", description: "제품 페이지 두 번째 슬라이드입니다.", defaultImage: "/images/product_bg-1.png" },
  { key: "productHeroImage3", title: "제품 배너 3", description: "제품 페이지 세 번째 슬라이드입니다.", defaultImage: "/images/product_bg-2.png" },
  { key: "productHeroImage4", title: "제품 배너 4", description: "제품 페이지 네 번째 슬라이드입니다.", defaultImage: "/images/product_bg-3.png" },
  { key: "productHeroImage5", title: "제품 배너 5", description: "제품 페이지 다섯 번째 슬라이드입니다.", defaultImage: "/images/product_bg-4.png" },

        ...
        <div className={styles.bottomGrid} id="faq">
          <div>
            ...
            <div className={styles.faqGrid}>
              {[
                { q: "Q1. 어떤 제품과 서비스를 제공하나요?", a: "ETCOMPANY는 스마트팜, 산업용 IoT, 임베디드 시스템, 교육기자재 및 OEM·ODM 솔루션을 제공합니다." },
                { q: "Q2. 제품에 대한 기술 상담이 가능한가요?", a: "네. 제품 선택부터 적용 방법, 기술 문의까지 전문 엔지니어가 상담해드립니다." },
                { q: "Q3. OEM·ODM 시제품 개발이 가능한가요?", a: "가능합니다. 제품 기획부터 PCB 설계, 펌웨어 개발, 기구 설계, 시제품 제작 및 양산까지 One-stop 서비스를 제공합니다." },
                { q: "Q4. 제품 구매는 어떻게 하나요?", a: "당사가 운영하는 이티몰 쇼핑몰 외 쿠팡, 네이버 등을 통해 구매할 수 있으며, 대량 구매는 별도 문의해 주시기 바랍니다." },
                { q: "Q5. 제품의 A/S는 어떻게 받을 수 있나요?", a: "고객센터를 통해 접수하시면 제품 확인 후 수리 또는 교환 절차를 안내해드립니다." },
                { q: "Q6. 제품 사용 매뉴얼과 자료는 어디에서 확인할 수 있나요?", a: "구매하시는 제품에 QR코드로 동봉되어 있습니다." },
                { q: "Q7. 스마트팜 구축 및 기술 지원이 가능한가요?", a: "네. 환경제어, 식물생장 LED, 센서, 통합제어 시스템 등 구축 및 기술 지원을 제공합니다." },
                { q: "Q8. 산업용 자동화 시스템도 맞춤 제작이 가능한가요?", a: "가능합니다. 고객 환경에 맞는 하드웨어와 소프트웨어를 설계하여 제공합니다." },
                { q: "Q9. 교육기관 납품 및 견적 요청이 가능한가요?", a: "네. 학교, 대학, 연구기관, 공공기관 등 다양한 교육기관 납품 및 견적 상담을 지원합니다." },
                { q: "Q10. 견적 및 상담은 어떻게 신청하나요?", a: "전화, 이메일 또는 홈페이지 문의를 통해 상담을 신청하실 수 있으며, 담당자가 빠르게 안내해드립니다." },
              ].map((faq, i) => (
